...
class ShopShark_ThemeConfig_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public function getStylesCss() {
		...
		if($_design_variation == 0) return "css/styles.css";
		if($_design_variation == 1) return "css/styles-dark.css";
		return "css/styles.css";
	}
	
	public function getSliderCss() {
		$_design_variation = Mage::getStoreConfig('milanoconfig/generaloptions/design_variation');
		if($_design_variation == 0) return "css/slider.css";
		if($_design_variation == 1) return "css/slider-dark.css";
	...
	public function getISGridPageLimit() {
		...
		if($_columnCount == 3) return 9;
		if($_columnCount == 4) return 16;
		if($_columnCount == 5) return 10;
		return 10;
